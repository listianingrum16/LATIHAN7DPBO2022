	...
	if($tstatus == "Sudah"){
		...
		<td>
			<button class='btn btn-danger'>
				<a href='delete.php?id_hapus=" . $id . "' style='color: white; font-weight: bold;'>Hapus</a>
			</button>
		</td>
		</tr>";
		$no++;
	...
	// Tampilan jika status task nya belum dikerjakan
		...
		<td>
			...
			<button class='btn btn-success' >
				<a href='finished.php?id_selesai=" . $id .  "' style='color: white; font-weight: bold;'>Selesai</a>
			</button>
		</td>
		</tr>";
		$no++;
